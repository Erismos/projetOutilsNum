...
set_target_properties(umf::disjoint_pool PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/disjoint_pool.lib"
  )

list(APPEND _cmake_import_check_targets umf::disjoint_pool )
list(APPEND _cmake_import_check_files_for_umf::disjoint_pool "${_IMPORT_PREFIX}/lib/disjoint_pool.lib" )
